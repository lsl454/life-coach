...
android { namespace = "com.example.lifecoach"; compileSdk = 35
    defaultConfig { applicationId = "com.example.lifecoach"; minSdk = 26; targetSdk = 35; versionCode = 1; versionName = "1.0" }
...
dependencies {
    implementation(platform("androidx.compose:compose-bom:2024.12.01")); androidTestImplementation(platform("androidx.compose:compose-bom:2024.12.01"))
